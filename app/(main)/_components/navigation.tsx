...
//           role="button"
//           className={cn(
//             "h-6 -6 text-muted-foreground rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 absolute top-3 right-2 opacity-0 group-hover/sidebar:opacity-100 transition",
...
//         <div className="mt-4">
//           <DocumentList />
//           <Item onClick={handleCreate} icon={Plus} label="Добавить страницу" />
//           <Popover>
